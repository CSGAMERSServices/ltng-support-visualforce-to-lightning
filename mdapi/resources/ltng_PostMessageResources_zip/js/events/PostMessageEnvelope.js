...
class PostMessageEnvelope {
	...
	**/
	 ...
	 *  @return String
	 *  <p>TypeScript getMessageOrigin( evt:PostMessageEnvelope ):String</p>
	**/
	 ...
	 *  <p>TypeScript: getPayload( evt:PostMessage ):PostMessageEnvelope</p>
	**/
	static parse( evt ){
		var results = null;
		try {
			...
			results = new PostMessageEnvelope( evt.data.sender, evt.data.messageType, evt.data.isSuccessful, evt.data.data );
